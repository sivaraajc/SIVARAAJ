...
/* harmony export */ });
/* harmony import */ var D_SIVA_PORTFOLIO_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
...
class ChatbotComponent {
  ...
  onSendMessage() {
    var _this = this;
    return (0,D_SIVA_PORTFOLIO_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      styles: ["@font-face {\n    font-family: \"CastoroTitling\";\n    src: url(\"https://s3.us-east-2.amazonaws.com/cdn.spotlessplace.com/wp-content/CastoroTitling-Regular.ttf\")\n      format(\"truetype\");\n  }\n  \n  @font-face {\n    font-family: BraahOne;\n    src: url(\"https://s3.us-east-2.amazonaws.com/cdn.spotlessplace.com/wp-content/Merriweather-Regular.ttf\");\n  }\n  \n  body[_ngcontent-%COMP%] {\n    margin: 0;\n    font-family: \"CastoroTitling\";\n    font-size: 12px;\n  }\n  @keyframes _ngcontent-%COMP%_zoom {\n    0% {\n      transform: scale(1);\n    }\n    50% {\n      transform: scale(1.2);\n    }\n    100% {\n      transform: scale(1);\n    }\n  }\n  #backgroundimg[_ngcontent-%COMP%] {\n    object-fit: cover;\n    object-position: center center;\n    width: 100%;\n    height: 100%;\n    position: fixed;\n    z-index: -1;\n    animation: _ngcontent-%COMP%_zoom 20s infinite alternate;\n  }\n  \n  .main[_ngcontent-%COMP%] {\n    background-color: rgba(255, 255, 255, 0.04);\n    aspect-ratio: 13/16;\n    width: 400px;\n    position: absolute;\n    left: 50%;\n    top: 60%;\n    transform: translate(-50%, -50%);\n    border-radius: 30px;\n    backdrop-filter: blur(4px);\n    border: 1px solid rgba(255, 255, 255, 0.3);\n    overflow: hidden;\n    transition: transform 1s ease, width 1s ease;\n  }\n  .main[_ngcontent-%COMP%]:hover {\n    width: 410px;\n  }\n  \n  .header[_ngcontent-%COMP%] {\n    color: #fff;\n    display: flex;\n    padding: 20px;\n    align-items: center;\n  }\n  \n  #pfpname[_ngcontent-%COMP%] {\n    transition: letter-spacing 0.3s ease;\n  }\n  #pfpname[_ngcontent-%COMP%]:hover {\n    letter-spacing: 2px;\n  }\n  \n  .notifications[_ngcontent-%COMP%] {\n    background: #2796db;\n    border-radius: 100%;\n    aspect-ratio: 1;\n    width: 25px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    margin-left: 5px;\n    cursor: pointer;\n    transition: transform 2s ease;\n  }\n  .notifications[_ngcontent-%COMP%]:hover {\n    transition: transform 2s ease;\n  }\n  .header[_ngcontent-%COMP%]   .pfp[_ngcontent-%COMP%] {\n    aspect-ratio: 1;\n    width: 40px;\n    border-radius: 100%;\n    cursor: pointer;\n    transition: transform 1s ease;\n  }\n  .pfp[_ngcontent-%COMP%]:hover {\n    transform: scale(1.2);\n  }\n  \n  .header[_ngcontent-%COMP%]   .center[_ngcontent-%COMP%] {\n    display: flex;\n    justify-content: center;\n    text-align: center;\n    width: 100%;\n  }\n  \n  .header[_ngcontent-%COMP%]   .center[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n    margin: 0;\n    font-weight: 700;\n  }\n  \n  .footer[_ngcontent-%COMP%] {\n    width: 100%;\n    height: 100px;\n    position: fixed;\n    bottom: 0;\n    display: inline-flex;\n    align-items: center;\n  }\n  \n  .text-box[_ngcontent-%COMP%] {\n    float: right;\n    border-radius: 100px;\n    border: 1px solid rgba(255, 255, 255, 0.6);\n    background: none;\n    padding: 8px 10px;\n    width: 65%;\n    outline: none;\n    color: #fff;\n    transition: transform 1s ease, width 1s ease;\n  }\n  .text-box[_ngcontent-%COMP%]:hover {\n    width: 75%;\n  }\n  \n  .send-ico[_ngcontent-%COMP%] {\n    color: #fff;\n    position: absolute;\n    right: 0;\n    background: #2796db;\n    border-radius: 100%;\n    margin-right: 15px;\n    margin-top: 3px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    padding: 13px;\n    cursor: pointer;\n  }\n  \n  .text-box[_ngcontent-%COMP%]::placeholder {\n    color: #c6c6c6;\n    font-family: BraahOne;\n  }\n  \n  .content[_ngcontent-%COMP%] {\n    width: 100%;\n    bottom: 100px;\n    position: absolute;\n    height: 300px;\n    text-align: center;\n    color: #afafaf;\n    overflow: auto;\n  }\n  \n  .msg-btn[_ngcontent-%COMP%] {\n    color: #fff;\n    word-wrap: break-word;\n    border-radius: 100px;\n    display: inline-block;\n    max-width: 100%;\n    font-size: 14px;\n    font-family: \"BraahOne\";\n  }\n  .msg-btn[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n    padding: 10px 15px;\n    margin: 0;\n  }\n  .msg-btn-holder[_ngcontent-%COMP%] {\n    padding-bottom: 30px;\n    width: 100%;\n    margin-top: 10px;\n  }\n  .receiver-msg[_ngcontent-%COMP%] {\n    background: #4c4c4c;\n    float: left;\n  }\n  .sender-msg[_ngcontent-%COMP%] {\n    background: #000000;\n    float: right;\n  }\n  @keyframes _ngcontent-%COMP%_rotate {\n    from {\n      rotate: 0deg;\n    }\n  \n    50% {\n      scale: 1 1.5;\n    }\n  \n    to {\n      rotate: 360deg;\n    }\n  }\n  \n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
/* harmony export */ });
/* harmony import */ var D_SIVA_PORTFOLIO_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
/* harmony import */ var D_SIVA_PORTFOLIO_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncIterator_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncIterator.js */ 51646);
  ...
  chat(message) {
    ...
    return (0,D_SIVA_PORTFOLIO_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        var _iteratorError;
        try {
          for (var _iterator = (0,D_SIVA_PORTFOLIO_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncIterator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(stream), _step; _iteratorAbruptCompletion = !(_step = yield _iterator.next()).done; _iteratorAbruptCompletion = false) {
