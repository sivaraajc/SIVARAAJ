...
const resolveRegion = /*#__PURE__*/function () {
  var _ref = (0,C_port_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (_region, _parentRegion, credentialProviderLogger, loaderConfig = {}) {
...
const getDefaultRoleAssumer = (stsOptions, STSClient) => {
  ...
  return /*#__PURE__*/function () {
    var _ref2 = (0,C_port_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (sourceCreds, params) {
      ...
      if (!stsClient) {
        ...
        stsClient = new STSClient({
          ...
          userAgentAppId,
          profile,
          credentialDefaultProvider: () => /*#__PURE__*/(0,C_port_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
const getDefaultRoleAssumerWithWebIdentity = (stsOptions, STSClient) => {
  let stsClient;
  return /*#__PURE__*/function () {
    var _ref4 = (0,C_port_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (params) {
      if (!stsClient) {
        const {
          logger = stsOptions?.parentClientConfig?.logger,
          profile = stsOptions?.parentClientConfig?.profile,
...
const createAggregatedClient = (commands, Client, options) => {
  for (const [command, CommandCtor] of Object.entries(commands)) {
    const methodImpl = /*#__PURE__*/function () {
      var _ref = (0,C_port_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (args, optionsOrCb, cb) {
  ...
  for (const [waiterName, waiterFn] of Object.entries(waiters)) {
    if (Client.prototype[waiterName] === void 0) {
      Client.prototype[waiterName] = /*#__PURE__*/(0,C_port_SIVARAAJ_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (commandInput = {}, waiterConfiguration, ...rest) {
